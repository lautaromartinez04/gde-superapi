                ...
                <div className="space-y-10 text-white leading-relaxed">
                    <section>
                        <div className="w-full flex justify-center">
                            <span className="block transform bg-[#E30613] text-white font-bold text-lg py-1 px-4 w-fit uppercase tracking-wider mb-2 shadow-md inline-block transform">{t('politicas.dato1')}</span>
                        </div>
                    ...
                    <section>
                        <div className="w-full flex justify-center">
                            <span className="block transform bg-[#E30613] text-white font-bold text-lg py-1 px-4 w-fit uppercase tracking-wider mb-2 shadow-md inline-block transform">{t('politicas.dato2')}</span>
                        </div>
                        <div className="w-12 h-1 bg-white my-3 opacity-80 mx-auto"></div>
                        <p className="text-lg font-light opacity-90 pl-2 border-l-2 border-[#E30613]/50 text-center">
                            {t('politicas.texto2')}
                    ...
                    <section>
                        <div className="w-full flex justify-center">
                            <span className="block transform bg-[#E30613] text-white font-bold text-lg py-1 px-4 w-fit uppercase tracking-wider mb-2 shadow-md inline-block transform">{t('politicas.dato3')}</span>
                        </div>
                        <div className="w-12 h-1 bg-white my-3 opacity-80 mx-auto"></div>
                        <p className="text-lg font-light opacity-90 pl-2 border-l-2 border-[#E30613]/50 text-center">
                            {t('politicas.texto3')}
                    ...
                    <section>
                        <div className="w-full flex justify-center">
                            <span className="block transform bg-[#E30613] text-white font-bold text-lg py-1 px-4 w-fit uppercase tracking-wider mb-2 shadow-md inline-block transform">{t('politicas.dato4')}</span>
                        </div>
                        <div className="w-12 h-1 bg-white my-3 opacity-80 mx-auto"></div>
                        <p className="text-lg font-light opacity-90 pl-2 border-l-2 border-[#E30613]/50 text-center">
                            {t('politicas.texto4')}
